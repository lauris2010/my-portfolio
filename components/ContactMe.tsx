...
function ContactMe({ pageInfo }: Props) {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-4xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-4 md:space-y-5 xl:space-y-7">
        ...
        <div className="">
          <div className="flex items-center space-x-5 justify-center">
            <PhoneIcon className="text-[#63048B] h-5 w-5 xl:h-7 xl:w-7 animate-pulse" />
            <p className=" text:xl xl:text-2xl">+37062593930</p>
          </div>
        </div>
        <div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#63048B] h-5 w-5 xl:h-7 xl:w-7 animate-pulse" />
            <p className=" text:xl xl:text-2xl">{pageInfo?.email}</p>
          </div>
        </div>
        <div>
          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#63048B] h-5 w-5 xl:h-7 xl:w-7 animate-pulse" />
            <p className="text:xl xl:text-2xl">Kaunas</p>
          </div>
        </div>
        <form
